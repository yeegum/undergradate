		...
		flow.load(
				{
					elem:'#announceList',
						...
						var lis=[];
						$.post('/getAnnounceList?page='+page,function (result) {
							layui.each(result.data, function(index, item){
								lis.push('<a href=announceContent.jsp?bt='+item+' title="查看详情"><li>'+ item+'</li></a> ');
							});
...
<div class="zy_gywm">
	<div class="ejdh" style="height: 1050px;">
		...
		<div class="women">
			<div class="btmc">
				<h1>P</h1>
				<p>公告展示<span>resentation</span></p>
			</div>
			<ul class="skb">
		...
		<div class="zy_dh_lb">
			<ul>
				<li id="women"><img src="images/zy1_08.png"><a id="wenzidangq" href="#">关于公告</a></li>
			</ul>
		</div>
	</div>
